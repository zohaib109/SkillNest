		...
		<div className="flex flex-col gap-6">
			<header>
				...
				<p className="mt-1 text-sm text-muted-foreground">
					Track demand now; lesson payments and payouts will be added once
					booking is enabled.
				</p>
			</header>
			...
			<div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
				<Metric
					...
					value="$0"
					detail="Payments are not enabled yet"
				/>
				<Metric
			...
			<div className="rounded-3xl border border-border bg-card p-5 shadow-2xs sm:p-6">
				...
				<p className="mt-2 max-w-2xl text-sm leading-relaxed text-muted-foreground">
					A complete profile, current availability, and an intro video give
					students the context they need to send a confident request.
				</p>
				<Link
